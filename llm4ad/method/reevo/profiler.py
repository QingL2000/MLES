...
class ReEvoProfiler(ProfilerBase):
    ...
    def _write_json(self, function: Function, program='', *, record_type='history', record_sep=200):
        ...
        if hasattr(function, 'operator'):
            content['operator'] = function.operator

        if hasattr(function, 'all_ins_performance'):
            content['all_ins_performance'] = function.all_ins_performance
